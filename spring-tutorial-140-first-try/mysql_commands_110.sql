...
| amandaking        | user      |
| eeeeeeeee2        | user      |
| jebthelowenergy   | user      |
| johnwpurcell      | user      |
| JuanWPurcello     | user      |
| JuanWPurcello3    | user      |
| Mike              | admin     |
| rhoda morgenstern | user      |
| ross1232          | user      |
| ross2132          | user      |
+-------------------+-----------+
11 rows in set (0.00 sec)

mysql> update authorities set authority='ROLE_ADMIN' where authority='admin';
Query OK, 2 rows affected (0.01 sec)
Rows matched: 2  Changed: 2  Warnings: 0

mysql> update authorities set authority='ROLE_USER' where authority='user';
